...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public SQLiteHandler(Context context) {
        super(context, SQLiteDBHelper.DatabaseName, null, SQLiteDBHelper.DatabaseVersion);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.beginTransaction();
        try {
            String[] cQuery = new String[]{SQLiteDBHelper.CTable_Menu, SQLiteDBHelper.CTable_Label, SQLiteDBHelper.CTable_Rbm};
            for (String sql : cQuery) {
                db.execSQL(sql);
            }
